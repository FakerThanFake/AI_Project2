...
def get_input_args():
    ...
    parser.add_argument('--arch', default = 'vgg', type = str, help = 'path to folder of images')
    parser.add_argument('--dogfile', default = 'dognames.txt',type = str, help = 'path to folder of images')
